        ...
        <article class="col-12">
            ...
            <section class="row section-criar-nucleo justify-content-center">
                <article class="col-12 mt-5 mb-3 position-relative">
                    <h2 id="title_sucesso" class="text-center h2-nucleo_save mb-4"> Página em construção. </h2>
                </article>
                <article class="col-12 px-4">
                        <section class="row justify-content-center mb-5">
                            <article class="col-12 text-center">
                                <p class="mb-4" id="sucesso_text"> Estamos a trabalhar para termos esta parte pronta brevemente
                                </p>
                                <img id="img_f1" class="img-fluid px-3 my-4" src="assets/asset_contrucao.svg">
                            </article>
                        </section>
